...
//       <div className="pt-[100px] px-10 pb-10 min-h-screen bg-gradient-to-r from-[rgba(135,206,235,0.1)] to-[#0f0f19]">
...
//           <div className="bg-[rgba(255,255,255,0.1)] backdrop-blur-md p-6 rounded-xl border border-[rgba(255,255,255,0.1)] max-[1024px]:sticky max-[1024px]:top-[100px]">
//             <h3 className="text-white mb-5">Filters</h3>
//             <div className="mb-5">
//               <label className="block text-[rgba(255,255,255,0.7)] mb-2">Job Type</label>
//               <select
//                 value={filters.jobType}
//                 onChange={(e) => setFilters({ ...filters, jobType: e.target.value })}
//                 className="w-full p-[10px] bg-[#363947] border border-[rgba(255,255,255,0.1)] rounded-[6px] text-white cursor-pointer"
//               >
...
//         <div className="grid grid-cols-[280px_1fr] gap-[30px] max-w-[1400px] mx-auto max-[1024px]:grid-cols-1">
//           <div className="bg-[rgba(54,57,71,0.8)] backdrop-blur-md p-4 rounded-xl border border-[rgba(255,255,255,0.1)] max-[1024px]:sticky max-[1024px]:top-[100px]">
